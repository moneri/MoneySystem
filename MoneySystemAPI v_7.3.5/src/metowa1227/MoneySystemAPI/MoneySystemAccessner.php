...
namespace {
	...
	interface MoneySystemAccessner{

		function Check(Player $player);
		function AddMoney(Player $player, $money);
		function TakeMoney(Player $player, $money);
		function SetMoney(Player $player, $money);
		function CreateAccount(string $name, $money);
		function RemoveAccount(string $name);
		function setPlayerDefaultMoney(Player $player, $money) : int;
		function getDefaultMoney();
		function setAllDefaultMoney();
		function setDefaultMoney($money) : int;
		function setAllCustomMoney($money) : int;
		function getMonitorUnit();
		function isEnable();
		function BackupFiles();
		function files_exists();
		function BackedupFiles();
		function getDefaulrLang();
		function ExistsAccount(string $name);
