...
class MoneySystemAPI extends PluginBase implements Listener{
    ...
    */
    ...
    const PACKAGE_VERSION = "9.0.0 beta API";

    const CODENAME = "GREEN PAPAYA (Green papaya / beta edition / poker face {build::8.9.9,productid::6.10.1023.10090}";
    ...
    */
    ...
    const PLUGIN_LAST_UPDATE = "2017/08/09";
    ...
    **/
	...
	public function onEnable(){
        ...
        if(!$this->config->exists("DataBaseType")){
            $this->config->set("DataBaseType", "YAML");
            $this->config->set("ConfigVersion", 9.0);
            $this->config->save();
