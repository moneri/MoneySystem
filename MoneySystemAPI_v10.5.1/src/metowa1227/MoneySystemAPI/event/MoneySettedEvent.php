...
class MoneySettedEvent extends MoneySystemEvent{

	/**
	**Money Setted Event, if cancel to cancel set money.
	**/
	...
	**/
	...
	/**
	**@return string, setted type
	**/

	public function getType(){
		switch($this->type){
			case "setmoney.command":
				return "setmoney.command";
			case "pay.command":
				return "pay.command";
			case "other.plugin":
				return "other.plugin";
...
/*
	...
	public function setCancelled($type = true){
		$this->api->setCancel("MoneySettedEvent", $this->player->getName(), $type);
	}

	public function isCancelled(){
		$result = $this->api->isCancel("MoneySettedEvent", $this->player->getName());
		return $result;
	}
