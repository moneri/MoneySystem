...
class MoneySystemAPI extends PluginBase implements Listener{
    ...
    */
    ...
    const PLUGIN_VERSION = "10.5.1";

    const PACKAGE_VERSION = "10.5.0 API";

    const CODENAME = "GREEN PAPAYA (Green papaya / beta edition / poker face {build::9.0.1,productid::8.63.1023.13290}";
    ...
    */
    ...
    const PLUGIN_LAST_UPDATE = "2017/09/02";
